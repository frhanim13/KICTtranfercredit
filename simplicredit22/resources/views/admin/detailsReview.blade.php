...
<!-- /.card -->
                ...
                <div class="card">
                    <div class="card-header">
                      <h3 class="card-title">Under Review Application from {{$matric_id}}</h3>
                    </div>
                    <!-- /.card-header -->
                      ...
                      <table class="table table-striped">
                        ...
                        {{ csrf_field() }}
                            <input type ="hidden" name="cid"  value="{{$each -> id}}">
                                  <select name="status" class="form-control" onchange="showfield(this.options[this.selectedIndex].value)">
