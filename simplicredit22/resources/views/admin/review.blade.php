    ...
    <!-- /.card -->
                    ...
                    <div class="card">
                        <div class="card-header">
                          <h3 class="card-title">Under Review Application</h3>
                        </div>
                        <!-- /.card-header -->
                          ...
                          <table class="table table-striped">
                            ...
                            <tbody>
                              <tr>
                                ...
                                <td> <a href="{{url('/admin/detailsReview/'.$each->matric_id)}}"><button type="button" class="btn btn-info"> see details</button> </a></td>
                              </tr>
                              @endforeach
